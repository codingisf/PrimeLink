...
function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Section - 1  */}
      <section className="relative lg:h-screen w-full text-white h-fit py-5 flex flex-col">
        <div className="absolute inset-0 z-[-1]">
          <img
            src="/Aboutus/1.Aboutus.jpg"
      ...
      <section className="bg-blue-50 w-full min-h-screen lg:px-30 lg:py-20 px-10 py-5">
        <p className="bg-white w-fit px-4 py-2 rounded-3xl my-5">About us</p>
        <div className="">
          ...
          <Reveal>
            <div className="max-w-98 bg-white  px-6 border-2 border-gray-300 rounded-xl py-4">
              <div className="flex gap-4 items-center">
                <div className="logo rounded-full w-15 h-15 overflow-hidden">
                  <img
                    src="/Aboutus/2.Mission.jpg"
                    alt="Mission"
                    loading="lazy"
                    className="w-full h-full object-cover"
                  />
      ...
      <section className="bg-blue-50 w-full min-h-screen lg:px-30 lg:py-20 px-5 py-10 text-white flex items-center">
        <div className="relative lg:h-[60vh] h-auto w-full mx-auto flex lg:flex-row flex-col justify-between items-center lg:gap-0 gap-10 py-10 lg:py-0 rounded-2xl overflow-hidden">
          <img
            src="/Aboutus/3.whychooseus.jpg"
            alt="Why Choose Us"
            loading="lazy"
          ...
          <div className="lg:w-1/2 px-5">
            <Reveal>
              ...
              <h1 className="text-black lg:text-4xl text-2xl font-semibold mt-2">
