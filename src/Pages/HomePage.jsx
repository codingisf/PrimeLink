...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* Home Section */}
      <section className="relative flex flex-col justify-center min-h-[100vh] py-3 w-full text-white">
        <div className="absolute inset-0 z-[-1]">
          <img
            src="/Homepage/1_Home_content.jpg"
            alt="Background"
            fetchpriority="high"
            className="w-full h-full object-cover"
          />
      ...
      <section className="w-full min-h-screen lg:px-30 lg:py-20 px-10 py-5">
        ...
        <div className="relative lg:w-[90%] mx-auto mt-8 gap-y-5 h-[80vh] rounded overflow-hidden">
          <img
            src="/Homepage/2Aboutushome.jpg"
            alt="About Us"
            loading="lazy"
    ...
    transition-all duration-300 hover:bg-transparent hover:text-[#152e44]"
      ...
      <section className="w-full min-h-screen px-10 py-5 lg:px-30 lg:py-20 bg-blue-100">
        <p className="bg-white w-fit px-4 py-2 rounded-3xl my-5 ">
          Why choose us?
        </p>
        ...
        <div className="mt-10 flex lg:flex-row flex-col justify-between gap-y-20">
          <div className="h-96 lg:w-[40%] rounded-xl overflow-hidden">
            <img
              src="/Homepage/4.Whychooseusimage.jpg"
              alt="Why Choose Us"
              loading="lazy"
              className="w-full h-full object-cover"
            />
          ...
          <div className="lg:w-[50%] ">
            <div className="flex justify-around items-center">
              <div className="h-16 w-16 rounded-full overflow-hidden shrink-0">
                <img
                  src="/Homepage/4.verified.jpg"
                  alt="Verified & Skilled Talent"
                  loading="lazy"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <div className="flex justify-around items-center">
              <div className="h-16 w-16 rounded-full overflow-hidden shrink-0">
                <img
                  src="/Homepage/4.Fast.jpg"
                  alt="Fast & Flexible Hiring"
                  loading="lazy"
                  className="w-full h-full object-cover"
                />
              </div>
    ...
    transition-all duration-300 hover:bg-transparent hover:text-[#152e44]"
      ...
      <section className="w-full lg:h-screen h-[50vh] ">
        <div className="relative lg:h-[80vh] w-full py-5 text-white flex flex-col justify-center items-center text-center gap-y-5">
          <img
