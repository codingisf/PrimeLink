...
function Servicepage() {
  ...
  return (
    <>
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="relative w-full text-white py-5 lg:h-screen flex flex-col">
        <div className="absolute inset-0 z-[-1]">
          <img
            src="/Servicepage/1.ServicePage.jpg"
      ...
      <section className="bg-blue-50 min-h-screen px-10 py-10 lg:px-28 lg:py-20">
        ...
        <div className="grid lg:grid-cols-3 gap-10 mt-16 justify-items-center">
          <Reveal>
            <div className="h-96 w-80 rounded-lg relative cursor-pointer overflow-hidden">
              <img
                src="/Servicepage/2.share.jpg"
                alt="Share Requirements"
                loading="lazy"
                className="absolute inset-0 w-full h-full object-cover"
              />
              <div className="absolute bottom-0 w-[90%] bg-[#152e44]/80 backdrop-blur-md rounded-t-lg left-1/2 -translate-x-1/2 z-10">
          ...
          <Reveal delay={0.2}>
            <div className="h-96 w-80 rounded-lg relative cursor-pointer overflow-hidden">
              <img
                src="/Servicepage/2.WeSource.jpg"
                alt="Source & Screen"
                loading="lazy"
                className="absolute inset-0 w-full h-full object-cover"
              />
        ...
        <div className=" mt-5">
          <div className="flex lg:flex-row flex-col justify-evenly w-full items-center gap-y-10">
            <Reveal width={null} className="w-full lg:w-fit">
              <div
                id="manpower-supply"
                className="relative bg-gray-200 w-full lg:w-[390px] gap-y-5 h-60 rounded-xl overflow-hidden cursor-pointer"
                onClick={handlefirstOpen}
              >
                <img
                  src="/Homepage/3.ManPowerSupply.png"
                  alt="Manpower Supply"
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="bg-gray-800 absolute w-[90%] min-h-10 bottom-1 left-1/2 -translate-x-1/2 rounded-t-xl z-10">
            ...
            <Reveal width={null} className="w-full lg:w-fit">
              ...
              >
                <img
                  src="/Homepage/3.OvearseasRequirement.jpg"
                  alt="Overseas Requirement"
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="bg-gray-800 absolute  w-[90%] min-h-10 bottom-1 left-1/2 -translate-x-1/2 rounded-t-xl z-10">
          ...
          <div className="flex lg:flex-row flex-col mt-10 w-full items-center justify-evenly gap-y-10 ">
            <Reveal width={null} className="w-full lg:w-fit">
              ...
              >
                <img
                  src="/Homepage/3.Temporaryandcontractstaffing.jpg"
                  alt="Temporary and Contract Staffing"
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="bg-gray-800 absolute  w-[90%] min-h-10 bottom-1 left-1/2 -translate-x-1/2 rounded-t-xl z-10">
            ...
            <Reveal width={null} className="w-full lg:w-fit">
              ...
              >
                <img
                  src="/Homepage/3.Clientsandcandidatessupport.jpg"
                  alt="Client and Candidates Support"
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="bg-gray-800 absolute  w-[90%] min-h-10 bottom-1 left-1/2 -translate-x-1/2 rounded-t-xl z-10">
      ...
      {/* ================= QUALITY GUARANTEE ================= */}
      <section className="bg-blue-50 px-10 py-10 lg:px-28 lg:py-20 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="bg-white rounded-lg flex gap-5 px-6 py-4 mt-6">
            <div className="h-16 w-14 overflow-hidden relative">
              <img
                src="/Servicepage/4.Quality.jpg"
                alt="Quality"
                loading="lazy"
                className="w-full h-full object-cover"
              />
        ...
        <div className="h-[50vh] lg:h-[70vh] w-full rounded-lg overflow-hidden relative">
          <img
            src="/Servicepage/5.Qualitygurantee.jpg"
