...
function IndustriesPage() {
  ...
  return (
    <>
      ...
      {/* Section - 1  */}
      <section className="bg-[url('/Industries/1.Industrieshome.jpg')] bg-cover bg-center lg:h-[100vh] w-full text-white h-fit py-5">
        <StickyNavbar />
      ...
      <section className="w-full min-h-screen">
        <div className="h-[80vh] w-full bg-[url('/Homepage/6.ContactonPrimelink.jpg')]  bg-cover bg-center bg-no-repeat text-white flex flex-col justify-center items-center text-center gap-y-5">
          <p>If you need</p>
