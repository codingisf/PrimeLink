...
const StickyNavbar = () => {
  ...
  useEffect(() => {
    ...
    else if (path.includes("industries")) setActiveItem("Industries");
    else setActiveItem("");
  }, [location]);
      ...
      <div className="flex items-center  justify-between text-white">
        ...
        <div className="flex items-center flex-col gap-5">
          ...
          <Link to="/" className="text-3xl font-bold text-center">
            PrimeLink <br /> <p className="text-xs"> Manpower & Staffing</p>
          </Link>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6 ">
          ...
          <Link
            to="/contact"
            className="ml-4 rounded-lg bg-[#152e44] border border-[#152e44]
             hover:bg-transparent px-4 py-2 text-sm font-semibold
